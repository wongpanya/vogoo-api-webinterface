...
// read files in php 
$file_handle_m = fopen("items.txt",'r') or exit("unable to open movies file");
...
while( ! feof($file_handle_m)) {
  ...
  $sql_query = " Insert into movies(id,name,date_of_release) values('$pieces[0]','$name','$genre')"  ;
...
$file_handle_u = fopen("user.txt",'r') or exit("unable to open users file");
